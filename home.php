...
<body>
  ...
  <section class="header">
    ...
    <nav class="navbar">
      ...
      <a href="login.php" class="btn" style="color: white;font-size: small;">log in</a>
      <a href="register.php" class="btn" style="color: white;background-color: rgb(125, 24, 120);;font-size: small;">Register</a>
    </nav>
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide" style="background:url(image/slide1.jpg)no-repeat">
          <div class="content">
            ...
            <a href="package2.php" class="btn">discover more</a>
          </div>
        </div>
  ...
  <section class="footer">
    ...
    <div class="box-container">
      <div class="box">
        ...
        <a href="package2.php"><i class="fas fa-angle-right"></i>packages</a>
